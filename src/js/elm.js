...
var _user$project$TrackerTypes$initialModel = function (name) {
	return {
		...
		otherSheets: _elm_lang$core$Native_List.fromArray(
			['blank-sheet']),
		name: name,
		rowHoverOvers: _elm_lang$core$Array$fromList(
			A2(_elm_lang$core$List$repeat, 256, false)),
		columnHoverOvers: _elm_lang$core$Array$fromList(
			A2(_elm_lang$core$List$repeat, 9, false))
	};
};
...
var _user$project$TrackerTypes$NewColumn = function (a) {
	return {ctor: 'NewColumn', _0: a};
};
var _user$project$TrackerTypes$RemoveRow = function (a) {
	return {ctor: 'RemoveRow', _0: a};
};
var _user$project$TrackerTypes$NewRow = function (a) {
	return {ctor: 'NewRow', _0: a};
};
...
var _user$project$TrackerTypes$ColumnIndexMouseOver = function (a) {
	return {ctor: 'ColumnIndexMouseOver', _0: a};
};
...
var _user$project$Dummies$dummyCell = _elm_lang$core$Maybe$withDefault(
...
var _user$project$Dummies$dummyTracker = {
	...
	rowHoverOvers: _elm_lang$core$Array$fromList(
		A2(_elm_lang$core$List$repeat, 9, false)),
	columnHoverOvers: _elm_lang$core$Array$fromList(
		A2(_elm_lang$core$List$repeat, 64, false))
};
...
var _user$project$Types$UpdateSheetName = F2(
	function (a, b) {
		return {ctor: 'UpdateSheetName', _0: a, _1: b};
	});
...
var _user$project$Init$initialModel = {
	sheets: _elm_lang$core$Dict$fromList(
		_elm_lang$core$Native_List.fromArray(
			[
				{ctor: '_Tuple2', _0: _user$project$Dummies$blankSheet.name, _1: _user$project$Dummies$blankSheet}
			])),
...
var _user$project$Util$trimZeros = function (str) {
	...
	while (true) {
		var _p0 = A2(
			...
			_elm_lang$core$String$uncons(str));
		var head$ = _p0._0;
		var tail$ = _p0._1;
...
var _user$project$Util$numberToHexString = _elm_lang$core$Dict$fromList(
	_elm_lang$core$Native_List.fromArray(
		[
			...
			{ctor: '_Tuple2', _0: 10, _1: 'a'},
			{ctor: '_Tuple2', _0: 11, _1: 'b'},
			{ctor: '_Tuple2', _0: 12, _1: 'c'},
			{ctor: '_Tuple2', _0: 13, _1: 'd'},
			{ctor: '_Tuple2', _0: 14, _1: 'e'},
			{ctor: '_Tuple2', _0: 15, _1: 'f'},
			{ctor: '_Tuple2', _0: 16, _1: 'g'},
			{ctor: '_Tuple2', _0: 17, _1: 'h'},
			{ctor: '_Tuple2', _0: 18, _1: 'i'},
			{ctor: '_Tuple2', _0: 19, _1: 'j'},
			{ctor: '_Tuple2', _0: 20, _1: 'k'},
			{ctor: '_Tuple2', _0: 21, _1: 'l'},
			{ctor: '_Tuple2', _0: 22, _1: 'm'},
			{ctor: '_Tuple2', _0: 23, _1: 'n'}
		]));

var _user$project$TrackerComponents$columnOptions = function (index) {
	return A2(
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_user$project$TrackerTypes$NewColumn(index))
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$html$Html_Events$onClick(
						_user$project$TrackerTypes$RemoveColumn(index))
					]),
				_elm_lang$core$Native_List.fromArray(
					[]))
			]));
...
var _user$project$TrackerComponents$columnIndexView = function (_p0) {
	...
	var child = _p3 ? A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_user$project$TrackerComponents$columnOptions(_p2)
			])) : A2(
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_user$project$TrackerTypes$ColumnIndexMouseOver(_p2)),
				_elm_lang$html$Html_Events$onMouseOut(
				_user$project$TrackerTypes$ColumnIndexMouseOut(_p2))
			]),
		_elm_lang$core$Native_List.fromArray(
			[child]));
};
...
var _user$project$TrackerComponents$rowOptions = function (index) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$html$Html_Attributes$value('x'),
						_elm_lang$html$Html_Events$onClick(
						_user$project$TrackerTypes$RemoveRow(index))
					]),
				_elm_lang$core$Native_List.fromArray(
					[])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$html$Html_Events$onClick(
						_user$project$TrackerTypes$NewRow(index))
					]),
				_elm_lang$core$Native_List.fromArray(
					[]))
			]));
...
var _user$project$TrackerComponents$rowIndexView = F3(
	function (radix, show, cells) {
		...
		var child = show ? A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_user$project$TrackerComponents$rowOptions(index)
				])) : A2(
			_elm_lang$html$Html$p,
			_elm_lang$core$Native_List.fromArray(
				[
...
var _user$project$TrackerHeader$downOption = function (str) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('drop-down-option')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('index-cell'),
						_elm_lang$html$Html_Events$onClick(
						_user$project$TrackerTypes$SetSheet(str))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$html$Html_Attributes$value(tracker.radixField),
								_elm_lang$html$Html_Events$onInput(_user$project$TrackerTypes$UpdateRadix)
							]),
						_elm_lang$core$Native_List.fromArray(
							[]))
					])),
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('column wide')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
				...
				A2(_user$project$TrackerHeader$button, 'new', _user$project$TrackerTypes$NewSheet),
				A2(_user$project$TrackerHeader$button, 'open', _user$project$TrackerTypes$Open),
				A2(_user$project$TrackerHeader$button, 'save', _user$project$TrackerTypes$Save),
				A2(_user$project$TrackerHeader$button, 'close', _user$project$TrackerTypes$CloseSheet),
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_user$project$TrackerComponents$columnNumbers(
				_elm_lang$core$Array$toList(columnHoverOvers))
			]));
};
...
var _user$project$ParseInt$toRadix$ = F2(
	function (radix, i) {
		return (_elm_lang$core$Native_Utils.cmp(i, radix) < 0) ? _elm_lang$core$String$fromChar(
			_user$project$ParseInt$charFromInt(i)) : A2(
			_elm_lang$core$Basics_ops['++'],
			A2(_user$project$ParseInt$toRadix$, radix, (i / radix) | 0),
			_elm_lang$core$String$fromChar(
				_user$project$ParseInt$charFromInt(
					A2(_elm_lang$core$Basics_ops['%'], i, radix))));
	});
var _user$project$ParseInt$toOct = _user$project$ParseInt$toRadix$(8);
var _user$project$ParseInt$toHex = _user$project$ParseInt$toRadix$(16);
var _user$project$ParseInt$isBetween = F3(
...
var _user$project$ParseInt$charOffset = F2(
	function (basis, c) {
		return _elm_lang$core$Char$toCode(c) - _elm_lang$core$Char$toCode(basis);
	});
var _user$project$ParseInt$InvalidRadix = function (a) {
	...
	function (radix, i) {
		return ((_elm_lang$core$Native_Utils.cmp(2, radix) < 1) && (_elm_lang$core$Native_Utils.cmp(radix, 36) < 1)) ? ((_elm_lang$core$Native_Utils.cmp(i, 0) < 0) ? _elm_lang$core$Result$Ok(
			A2(
				_elm_lang$core$Basics_ops['++'],
				'-',
				A2(_user$project$ParseInt$toRadix$, radix, 0 - i))) : _elm_lang$core$Result$Ok(
			A2(_user$project$ParseInt$toRadix$, radix, i))) : _elm_lang$core$Result$Err(
			_user$project$ParseInt$InvalidRadix(radix));
	});
var _user$project$ParseInt$OutOfRange = function (a) {
	return {ctor: 'OutOfRange', _0: a};
};
var _user$project$ParseInt$InvalidChar = function (a) {
	return {ctor: 'InvalidChar', _0: a};
};
var _user$project$ParseInt$intFromChar = F2(
	function (radix, c) {
		var validInt = function (i) {
			return (_elm_lang$core$Native_Utils.cmp(i, radix) < 0) ? _elm_lang$core$Result$Ok(i) : _elm_lang$core$Result$Err(
				_user$project$ParseInt$OutOfRange(c));
		};
		var toInt = A3(
			_user$project$ParseInt$isBetween,
			_elm_lang$core$Native_Utils.chr('0'),
			_elm_lang$core$Native_Utils.chr('9'),
			c) ? _elm_lang$core$Result$Ok(
			A2(
				_user$project$ParseInt$charOffset,
				_elm_lang$core$Native_Utils.chr('0'),
				c)) : (A3(
			_user$project$ParseInt$isBetween,
			_elm_lang$core$Native_Utils.chr('a'),
			...
			_user$project$ParseInt$InvalidChar(c))));
		return A2(_elm_lang$core$Result$andThen, toInt, validInt);
	});
var _user$project$ParseInt$parseIntR = F2(
	function (radix, rstring) {
		...
		if (_p0.ctor === 'Nothing') {
			...
			return A2(
				...
				A2(_user$project$ParseInt$intFromChar, radix, _p0._0._0),
				function (ci) {
					return A2(
						_elm_lang$core$Result$andThen,
						A2(_user$project$ParseInt$parseIntR, radix, _p0._0._1),
						function (ri) {
...
var _user$project$UpdateUtil$toListDeep = function (_p0) {
	return _elm_lang$core$Array$toList(
		A2(_elm_lang$core$Array$map, _elm_lang$core$Array$toList, _p0));
};
var _user$project$UpdateUtil$toArrayDeep = function (_p1) {
	return _elm_lang$core$Array$fromList(
		A2(_elm_lang$core$List$map, _elm_lang$core$Array$fromList, _p1));
};
var _user$project$UpdateUtil$setElement = F5(
	function (width, ri, ci, str, sheet) {
		var setter = A2(
			...
			A3(
				...
				A2(
					_elm_lang$core$Maybe$withDefault,
					_user$project$Dummies$dummyRow(width),
					A2(_elm_lang$core$Array$get, ri, sheet))));
		return setter(sheet);
	});
var _user$project$UpdateUtil$handleInt = function (result) {
	var _p2 = result;
	if (_p2.ctor === 'Ok') {
		return _p2._0;
	} else {
...
var _user$project$UpdateUtil$incrementName = function (name) {
	return A2(
		...
		_elm_lang$core$Basics$toString(
			A2(
				...
				1,
				_user$project$UpdateUtil$handleInt(
					_user$project$ParseInt$parseInt(
						A3(_elm_lang$core$String$slice, 12, 14, name))))));
};
var _user$project$UpdateUtil$makeNewName = F2(
	function (name, names) {
		makeNewName:
		while (true) {
			if (A2(_elm_lang$core$List$member, name, names)) {
				var _v1 = _user$project$UpdateUtil$incrementName(name),
					_v2 = names;
				name = _v1;
				names = _v2;
...
var _user$project$UpdateUtil$getNewSheetName = function (names) {
	return A2(_elm_lang$core$List$member, 'blank-sheet', names) ? A2(_user$project$UpdateUtil$makeNewName, 'blank-sheet-1', names) : 'blank-sheet';
};
var _user$project$UpdateUtil$packModel = function (model) {
	return {ctor: '_Tuple2', _0: model, _1: _user$project$Types$NoOp};
};
var _user$project$UpdateUtil$removeRow = F2(
	function (index, rows) {
		var afterIndex = function () {
			var l = _elm_lang$core$List$length(rows);
			return A3(
		...
		var beforeIndex = A3(
			...
			_elm_lang$core$Array$fromList(rows));
		return _elm_lang$core$Array$toList(
			A2(_elm_lang$core$Array$append, beforeIndex, afterIndex));
	});
var _user$project$UpdateUtil$newRow = F3(
	function (width, index, rows) {
		...
		var lefthalf = function () {
			...
			return A2(
				...
				_elm_lang$core$Array$fromList(
					_elm_lang$core$Native_List.fromArray(
						[
							A2(_elm_lang$core$List$repeat, width, '')
						])));
		}();
		return _elm_lang$core$Array$toList(
			A2(_elm_lang$core$Array$append, lefthalf, rightHalf));
	});
var _user$project$UpdateUtil$removeCell = F2(
	function (index, row) {
		var afterIndex = function () {
			var l = _elm_lang$core$List$length(row);
			return A3(
				_elm_lang$core$Array$slice,
				index + 1,
				l,
				_elm_lang$core$Array$fromList(row));
		}();
		var beforeIndex = A3(
			_elm_lang$core$Array$slice,
			0,
...
var _user$project$UpdateUtil$removeColumn = function (index) {
	return _elm_lang$core$List$map(
		_user$project$UpdateUtil$removeCell(index));
};
var _user$project$UpdateUtil$insertCell = F2(
	function (index, row) {
		var rightHalf = function () {
			var l = _elm_lang$core$List$length(row);
			return A3(
...
var _user$project$UpdateUtil$insertColumn = function (index) {
	return _elm_lang$core$List$map(
		_user$project$UpdateUtil$insertCell(index));
};
		...
		switch (_p0.ctor) {
			case 'UpdateCell':
				...
				return A2(
					...
					model,
					_user$project$Types$UpdateSheet(
						_elm_lang$core$Native_Utils.update(
							sheet,
							{
								data: function () {
									...
									var data = _p2.data;
									var width = _p2.width;
									return _user$project$UpdateUtil$toListDeep(
										A5(
											_user$project$UpdateUtil$setElement,
											width,
											_p0._0,
											_p0._1,
											_p0._2,
											_user$project$UpdateUtil$toArrayDeep(data)));
								}()
							})));
			case 'UpdateRadix':
				var _p4 = _p0._0;
				var newRadix = function () {
					if (_elm_lang$core$Native_Utils.eq(_p4, '')) {
						...
						var _p3 = _user$project$ParseInt$parseInt(_p4);
						if (_p3.ctor === 'Ok') {
							return _p3._0;
						} else {
							return 2;
				...
				return _user$project$UpdateUtil$packModel(
					_elm_lang$core$Native_Utils.update(
						model,
						{radixField: _p4, radix: newRadix}));
			case 'UpdateSheetName':
				...
				return A2(
					...
					model,
					A2(
						_user$project$Types$UpdateSheetName,
						sheet.name,
						_elm_lang$core$Native_Utils.update(
							sheet,
							{name: _p0._0})));
			...
			case 'NewSheet':
				var _p7 = model;
				var sheet = _p7.sheet;
				var otherSheets = _p7.otherSheets;
				var newName = _user$project$UpdateUtil$getNewSheetName(otherSheets);
				return A2(
					F2(
						function (v0, v1) {
							return {ctor: '_Tuple2', _0: v0, _1: v1};
			...
			case 'CloseSheet':
				var _p8 = model;
				var otherSheets = _p8.otherSheets;
				var sheet = _p8.sheet;
				return _elm_lang$core$Native_Utils.eq(
					_elm_lang$core$List$length(otherSheets),
					1) ? _user$project$UpdateUtil$packModel(model) : {
					ctor: '_Tuple2',
					_0: model,
			...
			case 'ColumnIndexMouseOver':
				return _user$project$UpdateUtil$packModel(
					_elm_lang$core$Native_Utils.update(
						model,
						{
							columnHoverOvers: A3(_elm_lang$core$Array$set, _p0._0, true, model.columnHoverOvers)
						}));
			case 'ColumnIndexMouseOut':
				return _user$project$UpdateUtil$packModel(
					_elm_lang$core$Native_Utils.update(
						model,
						{
							columnHoverOvers: A3(_elm_lang$core$Array$set, _p0._0, false, model.columnHoverOvers)
						}));
			case 'RowIndexMouseOver':
				return _user$project$UpdateUtil$packModel(
					_elm_lang$core$Native_Utils.update(
						model,
						{
							rowHoverOvers: A3(_elm_lang$core$Array$set, _p0._0, true, model.rowHoverOvers)
						}));
			case 'RowIndexMouseOut':
				return _user$project$UpdateUtil$packModel(
					_elm_lang$core$Native_Utils.update(
						model,
						{
							rowHoverOvers: A3(_elm_lang$core$Array$set, _p0._0, false, model.rowHoverOvers)
						}));
			case 'NewRow':
				var _p9 = model;
				var sheet = _p9.sheet;
						...
						_elm_lang$core$Native_Utils.update(
							sheet,
							{
								data: function () {
									...
									return A3(_user$project$UpdateUtil$newRow, width, _p0._0, data);
								}(),
				...
				return A2(
					...
					_user$project$Types$UpdateSheet(
						_elm_lang$core$Native_Utils.update(
							sheet,
							{
								data: A2(_user$project$UpdateUtil$removeRow, _p0._0, sheet.data),
								height: sheet.height - 1
							})));
			case 'NewColumn':
				var _p12 = model;
				...
				return A2(
					...
					_user$project$Types$UpdateSheet(
						_elm_lang$core$Native_Utils.update(
							...
							{
								data: A2(
									_user$project$UpdateUtil$insertColumn,
									_p0._0,
									A2(_user$project$UpdateUtil$removeColumn, 8, sheet.data))
							})));
			case 'RemoveColumn':
				var _p13 = model;
				var sheet = _p13.sheet;
				return A2(
					F2(
						function (v0, v1) {
							return {ctor: '_Tuple2', _0: v0, _1: v1};
...
_elm_lang$core$Native_Platform.addPublicModule(Elm['Aliases'], 'Aliases', typeof _user$project$Aliases$main === 'undefined' ? null : _user$project$Aliases$main);
Elm['Dummies'] = Elm['Dummies'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Dummies'], 'Dummies', typeof _user$project$Dummies$main === 'undefined' ? null : _user$project$Dummies$main);
Elm['Init'] = Elm['Init'] || {};
...
_elm_lang$core$Native_Platform.addPublicModule(Elm['ParseInt'], 'ParseInt', typeof _user$project$ParseInt$main === 'undefined' ? null : _user$project$ParseInt$main);
Elm['Ports'] = Elm['Ports'] || {};
